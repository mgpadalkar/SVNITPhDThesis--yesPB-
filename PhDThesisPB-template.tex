...
%------------------------------------------------------------------------------
% To remove the color for hyperlinks set the line 96 in SVNITPhDThesisPB.cls as 
% "colorlinks=false," from "colorlinks=true,".
%------------------------------------------------------------------------------
% Update with the current version
%----------------------------------
% The strict requirement of compiling using: LaTeX=>PS=>PDF is now removed with
% the use of class file SVNITPhDThesisPB.cls version 16.01.03 onwards.
% This can be now compiled with the PDFLatex command (however, you need to compile
% it with either pdflatex or LaTeX=>PS=>PDF command at least 3 times to get the
% borders at the right place).
% This also means that you no longer require your images to be in .eps format.
% Other image format viz. .jpg, .png, .bmp, etc. will also work!
% However, if you are using LaTeX=>PS=>PDF then you still need to have the images
% in .eps format
%------------------------------------------------------------------------------
% If page borders are not required then simply comment the following commands
% \addpageborder and \clearpageborder
%------------------------------------------------------------------------------
